    ...
    <div id="page-content-wrapper">
        ...
        <div class="container">
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h4 class="display-4">New Lecture</h4>
                    <hr class="my-2">
                    <div class="container">
                        <form method="get" action="create_lecture.php">
                            <?php include('../errors.php'); ?>
                            <div class="form-group">
                                <label class="col-sm-1-12 col-form-label" for="topic_name">Lecture Title</label>
                                <input type="text" class="form-control" name="topic_name" id="topic_name"
                                       value="<?php echo $topic_name; ?>" aria-describedby="helpId"
                                       placeholder="Lecture Title">
                                <small id="helpId" class="form-text text-muted">Enter lecture title here.</small>
                            </div>
                            <div class="form-group">
                                <label for="lecture">Lecture</label>
                                <textarea class="form-control" name="lecture" id="lecture"
                                          rows="20"><?php echo $lecture; ?></textarea>
                            </div>
                            <input type="hidden" id="course_id" name="course_id" value="<?php echo $_GET['id'] ?>">
                            <button type="submit" class="btn btn-success" name="pub_lecture">Publish Lecture</button>
                        </form>
                    </div>
                </div>
            </div>
